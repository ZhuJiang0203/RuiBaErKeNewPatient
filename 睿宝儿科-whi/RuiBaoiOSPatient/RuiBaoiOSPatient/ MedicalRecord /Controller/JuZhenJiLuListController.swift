//
//  JuZhenJiLuListController.swift
//  RuiBaoiOSDoctor
//
...
class JuZhenJiLuListController: BaseViewController {
...
extension JuZhenJiLuListController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc.model = jiuZhenJiLus[indexPath.row]
