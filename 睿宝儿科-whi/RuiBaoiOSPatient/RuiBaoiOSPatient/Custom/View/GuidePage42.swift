...
@objc
protocol GuidePage42Delegate: NSObjectProtocol {
    @objc optional func GuidePage42TurnOnLianKang()
}

private var GuidePage42ToolsW: CGFloat = 201
private var GuidePage42ToolCenterY: CGFloat = 49

class GuidePage42: UIView {
    
    weak var delegate: GuidePage42Delegate?
    ...
    fileprivate lazy var backImageView: UIImageView = {
        ...
        img.image = UIImage(named: "iPhoneguide42")
    ...
    fileprivate lazy var phone: UIImageView = {
        let img = UIImageView(frame: CGRect(x: 86.5, y: 32, width: 147, height: 275))
        img.image = UIImage(named: "GuidePage42Phone")
        img.isHidden = true
        return img
    }()
    ...
    fileprivate lazy var tools: UIImageView = {
        let imgH: CGFloat = 88
        let imgY: CGFloat = 109
        let imgX = (kScreenWidth - GuidePage42ToolsW)/2
        let img = UIImageView(frame: CGRect(x: imgX, y: imgY, width: GuidePage42ToolsW, height: imgH))
        img.image = UIImage(named: "tool42s")
        img.isHidden = true
        return img
    }()
    ...
    fileprivate lazy var tool1: UIImageView = {
        let imgW: CGFloat = GuidePage42ToolsW/4.0
        let imgY: CGFloat = GuidePage42ToolCenterY
        let imgX = imgW/2
        let img = UIImageView(frame: CGRect(x: 0, y: 0, width: 15, height: 15))
        img.image = UIImage(named: "tool421")
    ...
    fileprivate lazy var tool2: UIImageView = {
        ...
        let img = UIImageView(frame: CGRect(x: 0, y: 0, width: 15, height: 15))
        img.image = UIImage(named: "tool422")
        img.center = CGPoint(x: imgX, y: imgY)
        img.isHidden = true
        return img
    }()
    ...
    fileprivate lazy var tool3: UIImageView = {
        ...
        img.image = UIImage(named: "tool423")
        img.center = CGPoint(x: imgX, y: imgY)
        img.isHidden = true
        return img
    }()
    ...
    fileprivate lazy var tool4: UIImageView = {
        ...
        let img = UIImageView(frame: CGRect(x: 0, y: 0, width: 15, height: 15))
        img.image = UIImage(named: "tool424")
        img.center = CGPoint(x: imgX, y: imgY)
        img.isHidden = true
        return img
    }()
    ...
    fileprivate lazy var button: UIButton = {
        ...
        let btn = UIButton(frame: CGRect(x: 95, y: 428, width: 130, height: 36.5))
        ...
        btn.addTarget(self, action: #selector(GuidePage42.turnOnLianKang), for: .touchUpInside)
        btn.isHidden = true
    ...
    // MARK:- 开启连康
    func turnOnLianKang() {
        delegate?.GuidePage42TurnOnLianKang!()
    }
}
