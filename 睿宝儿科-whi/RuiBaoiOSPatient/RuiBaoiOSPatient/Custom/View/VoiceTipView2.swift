...
class VoiceTipView2: UIView {
    ...
    fileprivate static let tipView: VoiceTipView2 = {
        let tip = VoiceTipView2(frame: CGRect(x: 0, y: 0, width: kScreenWidth, height: kScreenHeight))
