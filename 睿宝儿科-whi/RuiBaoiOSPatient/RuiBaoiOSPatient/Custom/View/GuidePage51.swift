...
private var GuidePage51PhoneW: CGFloat = 251

class GuidePage51: UIView {
    ...
    func guidePage1Recovery() {
        ...
        phone.frame.origin.x = -GuidePage51PhoneW
    ...
    fileprivate lazy var backImageView: UIImageView = {
        ...
        img.image = UIImage(named: "iPhoneguide51")
        return img
    }()
    
    // 手机
    fileprivate lazy var phone: UIImageView = {
        let img = UIImageView(frame: CGRect(x: -GuidePage51PhoneW, y: 288, width: GuidePage51PhoneW, height: 47))
        img.image = UIImage(named: "GuidePage51Phone")
        return img
    }()
    
    // 阴影
    fileprivate lazy var shadow: UIImageView = {
        let img = UIImageView(frame: CGRect(x: 109.5, y: 303, width: 101, height: 17))
        img.isHidden = true
        img.image = UIImage(named: "GuidePage51Shadow")
        return img
    }()
    
    // 光
    fileprivate lazy var light: UIImageView = {
        let img = UIImageView(frame: CGRect(x: 53.5, y: 184, width: 213, height: 137))
        img.isHidden = true
        img.image = UIImage(named: "GuidePage51Light")
        return img
    }()
    
    // 聊天框
    fileprivate lazy var consulation: UIImageView = {
        let img = UIImageView(frame: CGRect(x: 52.5, y: 65, width: 215, height: 140))
        img.image = UIImage(named: "GuidePage51Consulation")
        img.isHidden = true
        return img
    }()
    ...
    fileprivate lazy var progress1: UIImageView = {
        ...
        img.image = UIImage(named: "SpeedOfProgress5113")
        return img
    }()
    ...
    fileprivate lazy var progress2: UIImageView = {
        ...
        img.image = UIImage(named: "SpeedOfProgress512")
        return img
    }()
    ...
    fileprivate lazy var icon: UIImageView = {
        let img = UIImageView(frame: CGRect(x: kScreenWidth, y: 229, width: 85, height: 85))
        img.image = UIImage(named: "GuidePage51Icon")
        /********************* 如果是睿宝，则打开下面代码 *******************/
        img.image = UIImage(named: "GuidePage51IconRuiBao")
        return img
    }()
    
    // 标题1
    fileprivate lazy var title1: UILabel = {
        let lbl = UILabel(frame: CGRect(x: 98.5, y: 418, width: 0, height: 30))
    ...
    fileprivate lazy var title2: UILabel = {
        let lbl = UILabel(frame: CGRect(x: 98.5, y: 448, width: 0, height: 22))
